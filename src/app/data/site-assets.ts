...
export const SITE_ASSETS = {
  ...
  luxuryAlaskaWhiteKitchen: asset('luxury-alaska-kitchen.png'),
  luxuryCommercialReception: asset('luxury-reception.png'),
  luxuryPatagoniaBacklit: asset('luxury-patagonia-wall.jpg'),
  rawFantasyBrown: asset('raw-fantasy-brown.png'),
  rawAlaskanWhite: asset('raw-alaskan-white.jpg'),
  rawPatagoniaCommercial: asset('raw-patagonia-commercial.jpg'),
  rawPatagoniaQuartz: asset('raw-patagonia-quartz.jpg'),
